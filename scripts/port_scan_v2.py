...
def scan_ports(ip, start_port, end_port):
    ...
    print "Escaneando puertos del", start_port, "al", end_port, "en", ip, "..."
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print "Uso: python port_scan.py <IP> <rango de puertos>"
        print "Ejemplo: python port_scan.py 192.168.1.1 1-1024"
        sys.exit(1)
